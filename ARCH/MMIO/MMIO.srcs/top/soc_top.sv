module soc_top #(
    ...
    // AXI-Lite link from interconnect to ASCON slave
    logic [31:0] ascon_axi_awaddr;
    logic        ascon_axi_awvalid;
    logic        ascon_axi_awready;
    logic [31:0] ascon_axi_wdata;
    logic [3:0]  ascon_axi_wstrb;
    logic        ascon_axi_wvalid;
    logic        ascon_axi_wready;
    logic [1:0]  ascon_axi_bresp;
    logic        ascon_axi_bvalid;
    logic        ascon_axi_bready;
    logic [31:0] ascon_axi_araddr;
    logic        ascon_axi_arvalid;
    logic        ascon_axi_arready;
    logic [31:0] ascon_axi_rdata;
    logic [1:0]  ascon_axi_rresp;
    logic        ascon_axi_rvalid;
    logic        ascon_axi_rready;
    ...
    (* keep_hierarchy = "yes", dont_touch = "yes" *)
    axil_interconnect_1x3 u_axil_ic (
        .clk          (clk),
        .rst_n        (rst_n),
        ...
        .m_ascon_awaddr (ascon_axi_awaddr),
        .m_ascon_awvalid(ascon_axi_awvalid),
        .m_ascon_awready(ascon_axi_awready),
        .m_ascon_wdata  (ascon_axi_wdata),
        .m_ascon_wstrb  (ascon_axi_wstrb),
        .m_ascon_wvalid (ascon_axi_wvalid),
        .m_ascon_wready (ascon_axi_wready),
        .m_ascon_bresp  (ascon_axi_bresp),
        .m_ascon_bvalid (ascon_axi_bvalid),
        .m_ascon_bready (ascon_axi_bready),
        .m_ascon_araddr (ascon_axi_araddr),
        .m_ascon_arvalid(ascon_axi_arvalid),
        .m_ascon_arready(ascon_axi_arready),
        .m_ascon_rdata  (ascon_axi_rdata),
        .m_ascon_rresp  (ascon_axi_rresp),
        .m_ascon_rvalid (ascon_axi_rvalid),
        .m_ascon_rready (ascon_axi_rready)
    );
    ...
    // Ascon AXI-Lite slave instance
    (* keep_hierarchy = "yes", dont_touch = "yes" *)
    axil_ascon_slave u_ascon_axi (
        .clk          (clk),
        .rst_n        (rst_n),
        .s_axi_awaddr (ascon_axi_awaddr),
        .s_axi_awvalid(ascon_axi_awvalid),
        .s_axi_awready(ascon_axi_awready),
        .s_axi_wdata  (ascon_axi_wdata),
        .s_axi_wstrb  (ascon_axi_wstrb),
        .s_axi_wvalid (ascon_axi_wvalid),
        .s_axi_wready (ascon_axi_wready),
        .s_axi_bresp  (ascon_axi_bresp),
        .s_axi_bvalid (ascon_axi_bvalid),
        .s_axi_bready (ascon_axi_bready),
        .s_axi_araddr (ascon_axi_araddr),
        .s_axi_arvalid(ascon_axi_arvalid),
        .s_axi_arready(ascon_axi_arready),
        .s_axi_rdata  (ascon_axi_rdata),
        .s_axi_rresp  (ascon_axi_rresp),
        .s_axi_rvalid (ascon_axi_rvalid),
        .s_axi_rready (ascon_axi_rready)
    );
endmodule
