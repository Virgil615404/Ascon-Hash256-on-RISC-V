module soc_top #(
    ...
    axil_interconnect_1x3 u_axil_ic (
        ...
        .m_dma_awaddr  (dma_axi_awaddr),
        .m_dma_awvalid (dma_axi_awvalid),
        .m_dma_awready (dma_axi_awready),
        .m_dma_wdata   (dma_axi_wdata),
        .m_dma_wstrb   (dma_axi_wstrb),
        .m_dma_wvalid  (dma_axi_wvalid),
        .m_dma_wready  (dma_axi_wready),
        .m_dma_bresp   (dma_axi_bresp),
        .m_dma_bvalid  (dma_axi_bvalid),
        .m_dma_bready  (dma_axi_bready),
        .m_dma_araddr  (dma_axi_araddr),
        .m_dma_arvalid (dma_axi_arvalid),
        .m_dma_arready (dma_axi_arready),
        .m_dma_rdata   (dma_axi_rdata),
        .m_dma_rresp   (dma_axi_rresp),
        .m_dma_rvalid  (dma_axi_rvalid),
        .m_dma_rready  (dma_axi_rready)
    );

    (* keep_hierarchy = "yes", dont_touch = "yes" *)
    axil_dma_asconhash256 u_dma_ascon (
        .clk          (clk),
        .rst_n        (rst_n),
