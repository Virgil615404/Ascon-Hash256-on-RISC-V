...
always @(*) begin
    case(control_signal)
        ...
        4'b1100: ALU_result = ($signed(read_data1) < $signed(ALU_data2)) ? 32'd1 : 32'd0;
...
always @(*) begin
    case(control_signal)
        ...
        4'b1011: ALU_zero = (read_data1 != ALU_data2) ? 1'b1 : 1'b0; // bne
        4'b1100: ALU_zero = ($signed(read_data1) < $signed(ALU_data2)) ? 1'b1 : 1'b0; // blt / slt
        4'b1101: ALU_zero = ($signed(read_data1) >= $signed(ALU_data2)) ? 1'b1 : 1'b0; // bge
        4'b0110: ALU_zero = (read_data1 < ALU_data2) ? 1'b1 : 1'b0; // bltu / sltu
        4'b1110: ALU_zero = (read_data1 >= ALU_data2) ? 1'b1 : 1'b0; // bgeu
